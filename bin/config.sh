...
# Start in the dotfiles directory
...
function doIt() {
	rsync --exclude ".git/" --exclude ".DS_Store" --exclude "bootstrap.sh" --exclude "bin" \
...
defaults write com.apple.finder NewWindowTargetPath -string "file://${HOME}/Dropbox/Inbox"
...
if [ "${CURRENT_PROFILE}" != "${TERM_PROFILE}" ]; then
	open "${HOME}/.dotfiles/config/Terminal/${TERM_PROFILE}.terminal";
...
#defaults write com.apple.iCal IncludeDebugMenu -bool tru
